...
@Module({
    imports: [MongooseModule.forFeature([{ name: 'Sale', schema: SaleSchema }, { name: 'User', schema: UserSchema }, { name: 'Candy', schema: CandySchema } ]), TypeOrmModule.forFeature([UserRepository, SaleRepository])],
